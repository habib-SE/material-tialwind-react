...
import { FaMapMarker, FaUniversity, FaCheck } from "react-icons/fa";
      ...
      <div className="profile-container">
        <div className="relative h-screen">
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <img
              src={Image2}
              className="h-40 w-40 mt-[-250%] rounded-full"
              alt="/"
            />
          </div>
          <div className="max-w-[1200px] md:flex p-8 border rounded-lg mx-20 bg-white mt-[130px] w-full h-[95%] justify-center">
            <div className="absolute mr-[75%] transform -translate-x-1/2">
            ...
            <div className="absolute mr-[43%] transform -translate-x-1/2">
            ...
            <ul className="text-xl p-8 space-x-10 hidden mr-[60%] md:flex">
              ...
              <li className="text-slate-400">Comments</li>
            </ul>
          ...
          <div className="absolute top-[80%] ml-[49%] transform -translate-x-1/2 -translate-y-1/2">
            <Line />
          ...
          <button className="absolute top-[90%] ml-[49%] uppercase transform -translate-x-1/2 -translate-y-1/2 mt-2 font-bold text-blue-700 h-10 mr-4 py-2 px-4 rounded-md hover:bg-slate-200">
            Show more
          </button>
        </div>
      </div>
